...
a[1, 1, 1, 2]
#Slection of the values in row 1, column 1, level 1 and level set 2.
a[2, 3, 2, ]
#Selection of the values in row 2, column 3 and level 2 from every level set.
a[1:5, 1:5, 3, 3]
#Selection of the values from row and column 1-5 from level 3 of the level set 3.
...
df<-data.frame(m3)
as.logical(df[,2])
#I am indicating that the values from column 2 of the data frame become logical values.
as.factor(df[,3])
#I am indicating that the values from column 3 of the data frame become factor values (1 or 2).
str(df)
